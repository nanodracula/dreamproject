// Supabase self-hosted functions router, copied from the live deployment on
// September 13, 2026 (release 20260911T124727Z-54169b6026ae, image
// supabase/edge-runtime:v1.74.0) with `importMapPath = null`; function sources
// carry explicit specifiers. Kept in upstream formatting and excluded from lint/fmt so it
// stays diffable; type checking is off because `EdgeRuntime` is a runtime-provided global.
// Review upstream changes when upgrading the Edge Runtime image. See server/README.md.
// @ts-nocheck
